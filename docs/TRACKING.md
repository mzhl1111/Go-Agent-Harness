...
- [x] Introduce a persistent `Cell` execution abstraction distinct from an agent turn.
...
- [ ] Model host-side cancellation of a pending nested invocation without invoking its executor.
